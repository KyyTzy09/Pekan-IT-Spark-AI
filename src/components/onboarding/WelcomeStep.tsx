    ...
    <div className="space-y-5">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[12px] leading-relaxed text-muted-foreground">
              Temen belajar AI kamu. Isi beberapa hal dulu biar aku bisa
              nemenin kamu dengan pas.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-3">
        <button
          ...
          className="group relative overflow-hidden rounded-2xl border border-border/40 bg-card/60 p-5 text-left backdrop-blur-sm transition-all hover:border-[var(--teal)]/40 hover:shadow-[0_8px_24px_rgba(20,184,166,0.12)]"
        >
          <div
            aria-hidden
          ...
          <div className="relative flex items-start gap-3">
            <span className="grid size-12 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-[var(--teal)] to-[var(--blue)] text-white shadow-[0_4px_12px_rgba(20,184,166,0.3)] transition-transform group-hover:-translate-y-0.5">
        ...
        <button
          ...
          className="group relative overflow-hidden rounded-2xl border border-border/40 bg-card/60 p-5 text-left backdrop-blur-sm transition-all hover:border-[var(--coral)]/40 hover:shadow-[0_8px_24px_rgba(225,29,72,0.12)]"
        >
          <div
            aria-hidden
            className="pointer-events-none absolute -left-8 -top-8 size-28 rounded-full opacity-20 blur-2xl"
            style={{
              background:
          ...
          />
          <div className="relative flex items-start gap-3">
            <span className="grid size-12 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-[var(--coral)] to-[var(--orange)] text-white shadow-[0_4px_12px_rgba(225,29,72,0.3)] transition-transform group-hover:-translate-y-0.5">
            ...
            <div>
              ...
              <div className="mt-2 flex flex-wrap gap-1.5">
                {["Input Nama Mapel", "AI Generate", "Pretest"].map(
                  (tag) => (
                    <span
                      key={tag}
      ...
      <div className="rounded-2xl border border-[var(--purple)]/20 bg-[var(--purple)]/5 p-3.5 backdrop-blur-sm">
        <div className="flex items-start gap-2.5">
          <Sparkles size={14} strokeWidth={2.5} className="mt-0.5 shrink-0 text-[var(--purple)]" />
          <p className="text-[11px] leading-relaxed text-muted-foreground">
            <span className="font-bold text-foreground">Tips:</span>{" "}
            Pilih kalo kamu mau mapel yang biasanya dipelajari di sekolah
            (Matematika, Fisika, dll). Pilih{" "}
            <span className="font-bold">Bikin mapel kustom</span> kalau
            mapel kamu unik atau ga ada di kurikulum nasional.
          </p>
        </div>
      </div>
    </div>
