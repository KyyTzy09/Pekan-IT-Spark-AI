...
export default function Loading() {
  return (
    <div className="flex min-h-[60vh] w-full flex-col items-center justify-center gap-4 py-20 text-center animate-fade-in">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-muted-foreground">
          Spark sedang mengambil data terbaik untukmu.
        </p>
      </div>
    </div>
  );
