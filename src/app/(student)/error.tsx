...
export default function StudentError({
  ...
  return (
    <div className="grid min-h-[60vh] place-items-center">
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-destructive/30 bg-card/80 p-6 text-center shadow-[0_10px_30px_rgba(225,29,72,0.1)] backdrop-blur-xl sm:p-8">
        <div
          aria-hidden
        ...
        <div className="relative flex flex-col items-center gap-4">
          <span className="grid size-12 place-items-center rounded-2xl bg-gradient-to-br from-[var(--coral)] to-[var(--orange)] text-white shadow-[0_8px_22px_rgba(225,29,72,0.35)]">
          ...
          <div>
            ...
            <h1 className="mt-1 font-heading text-[20px] font-bold leading-tight text-foreground">
              Halaman error dulu sebentar
            </h1>
            <p className="mt-1.5 text-[12.5px] leading-relaxed text-muted-foreground">
              Spark lagi cari tau masalahnya. Coba refresh dulu, kalo masih
              error balik ke beranda.
            </p>
            {error.digest && (
