        ...
        <div className="relative flex flex-col items-center gap-4">
          ...
          <div>
            ...
            <h1 className="mt-1 font-heading text-[20px] font-bold leading-tight text-foreground">
              Dashboard Orang Tua Error
            </h1>
            <p className="mt-1.5 text-[12.5px] leading-relaxed text-muted-foreground">
              Terjadi kesalahan di dashboard monitoring orang tua. Coba refresh
              atau kembali ke dashboard orang tua.
            </p>
            {error.digest && (
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            ...
            >
              <Link href="/parent">
                <Home size={13} /> Dashboard Orang Tua
              </Link>
            </Button>
          </div>
        </div>
