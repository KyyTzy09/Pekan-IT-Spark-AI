...
export default async function ParentDashboardPage({
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-12">
      ...
      {timeline && timeline.points.length > 0 && (
        <section className="rounded-3xl border border-border/40 bg-card/50 p-5 shadow-sm backdrop-blur-xl sm:p-6">
          <header className="mb-4">
            <h2 className="font-heading text-[16px] font-bold text-foreground">
              Aktivitas Belajar 7 Hari Terakhir
            </h2>
            <p className="text-[12px] text-muted-foreground">
              Menunjukkan breakdown harian aktivitas {activeChild.name}{" "}
              menyelesaikan misi belajar.
            </p>
          </header>
